...
export const concatTypedArrays = (array1, array2) => {
...
export const fitByteArray = (array, size) => {
...
export class Uint8ArrayConsumableBuffer {
	offset: any;
	binary: any;
	constructor(binary) {
		this.offset = 0;
...
export const uintToBuffer = (uintValue, bufferSize) => {
