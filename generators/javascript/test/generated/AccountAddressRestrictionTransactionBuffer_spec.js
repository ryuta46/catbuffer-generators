...
const { AccountAddressRestrictionTransactionBuffer } = require('../../../../_generated/js/AccountAddressRestrictionTransactionBuffer.js')


describe('AccountAddressRestrictionTransactionBuffer generated class', function () {
    it('has required getters and setters', function(done) {
        var buffer = new AccountAddressRestrictionTransactionBuffer()
        buffer.getSize()
        buffer.setSize(null)
        buffer.getSignature()
    ...
    it('loadFromBinary initializes from binary data', function(done) {
        var modificationBuffer1 = new AccountAddressRestrictionModificationBuffer()
        ...
        var modificationBuffer2 = new AccountAddressRestrictionModificationBuffer()
        ...
        var buffer = AccountAddressRestrictionTransactionBuffer.loadFromBinary(consumableBuffer)
