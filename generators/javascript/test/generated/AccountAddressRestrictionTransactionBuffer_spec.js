...
describe('AccountAddressRestrictionTransactionBuffer generated class', () => {
	it('has required getters and setters', () => {
		const buffer = new AccountAddressRestrictionTransactionBuffer();
		buffer.getSize();
		buffer.setSize(null);
		buffer.getSignature();
	...
	it('loadFromBinary initializes from binary data', () => {
		const modificationBuffer1 = new AccountAddressRestrictionModificationBuffer();
		...
		const modificationBuffer2 = new AccountAddressRestrictionModificationBuffer();
		...
		const buffer = AccountAddressRestrictionTransactionBuffer.loadFromBinary(consumableBuffer);
