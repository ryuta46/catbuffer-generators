...
const { TransactionTypePropertyTransactionBuffer } = require('../../../../_generated/js/TransactionTypePropertyTransactionBuffer.js')


describe('TransactionTypePropertyTransactionBuffer generated class', function () {
    it('has required getters and setters', function(done) {
        var buffer = new TransactionTypePropertyTransactionBuffer()
        buffer.getSize()
        buffer.setSize(null)
        buffer.getSignature()
    ...
    it('loadFromBinary initializes from binary data', function(done) {
        var modificationBuffer1 = new TransactionTypePropertyModificationBuffer()
        ...
        var modificationBuffer2 = new TransactionTypePropertyModificationBuffer()
        ...
        var buffer = TransactionTypePropertyTransactionBuffer.loadFromBinary(consumableBuffer)
