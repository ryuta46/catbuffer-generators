...
const { AccountOperationRestrictionTransactionBuffer } =
	require('../../../../_generated/js/AccountOperationRestrictionTransactionBuffer.js');


describe('AccountOperationRestrictionTransactionBuffer generated class', () => {
	it('has required getters and setters', () => {
		const buffer = new AccountOperationRestrictionTransactionBuffer();
		buffer.getSize();
		buffer.setSize(null);
		buffer.getSignature();
	...
	it('loadFromBinary initializes from binary data', () => {
		const modificationBuffer1 = new AccountOperationRestrictionModificationBuffer();
		...
		const modificationBuffer2 = new AccountOperationRestrictionModificationBuffer();
		...
		const buffer = AccountOperationRestrictionTransactionBuffer.loadFromBinary(consumableBuffer);
